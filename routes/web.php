...
Route::get("dashboard",[AuthController::class,"dashboard"])->name("dashboard");
    ...
    Route::middleware(["admin_auth"])->group(function(){
        ...
        Route::prefix("user")->group(function(){
            ...
            Route::get("delete/{id}",[UserController::class,"deleteUserList"])->name("admin#deleteUserList");
            Route::get("updatePage/{id}",[UserController::class,"userListUpdatePage"])->name("admin#userListUpdatePage");
            Route::post("update",[UserController::class,'updateUserList'])->name("admin#updateUserList");
            // Route::get("search",[UserController::class,"searchUserList"])->name("admin#searchUserList");
        });

        //contact
        Route::prefix("contact")->group(function(){
            Route::get("list",[ContactController::class,"contactList"])->name("admin#contactList");
            Route::get("delete/list/{id}",[ContactController::class,"deleteContactList"])->name("admin#deleteContactList");
        });
    });
    ...
    Route::group(["prefix"=>"user","middleware"=>"user_auth"],function()
    {
        ...
        Route::prefix("pizza")->group(function(){
            Route::get("detail/{id}",[UserController::class,"details"])->name("user#details");
        });
        ...
        Route::prefix("contact")->group(function(){
            Route::get("home",[ContactController::class,"contactPage"])->name("user#contactPage");
        ...
        Route::prefix("ajax")->group(function(){
            ...
            Route::get("increase/viewCouont",[AjaxController::class,"increaseViewCount"])->name("ajax#increaseViewCount");
        });
    });
});
