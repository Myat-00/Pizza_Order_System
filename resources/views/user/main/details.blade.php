...
@section("content")
        ...
        <div class="row px-xl-5 mb-3">
            <div class="">
                <a href="{{route("user#home")}}" class="text-dark">
                    <i class="fa-solid fa-arrow-left"><span class="ms-2">back</span></i>
                </a>
            </div>
        </div>
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex mb-3">
                        <h6 class="pt-1"><i class="fa-solid fa-eye ml-1"></i>{{$pizza->view_count+1}}</h6>
                    </div>
                ...
                <div class="owl-carousel related-carousel">
                    ...
                    <div class="product-item bg-light">
                        <div class="product-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="{{asset("storage/".$pizzaList->image)}}" style="height: 280px">
                            <div class="product-action">
                                <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a>
                                <a class="btn btn-outline-dark btn-square" href="{{route("user#details",$pizzaList->id)}}"><i class="fa-solid fa-circle-info"></i></a>
                            </div>
                        </div>
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate" href="">{{$pizzaList->name}}</a>
                            <div class="d-flex align-items-center justify-content-center mt-2">
                                <h5>{{$pizzaList->price}} Ks</h5><h6 class="text-muted ml-2"></h6>
                            </div>
                            <div class="d-flex align-items-center justify-content-center mb-1">
                                <h6>{{$pizza->view_count}}<i class="fa-solid fa-eye ms-1"></i></h6>
                            </div>
                        </div>
                    </div>
                    @endforeach
    ...
    <script>
        $(document).ready(function(){
            ...
            $.ajax({
                    type : "get",
                    url : "/user/ajax/increase/viewCouont",
                    data : {
